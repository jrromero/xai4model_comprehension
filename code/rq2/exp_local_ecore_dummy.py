...
X_test = pd.read_csv('D:\Descargas\datasets\ecore_dummy_x_test.csv', index_col=0)
X_train = pd.read_csv('D:\Descargas\datasets\ecore_dummy_x_train.csv', index_col=0)
y_test_csv = pd.read_csv('D:\Descargas\datasets\ecore_dummy_y_test.csv', index_col=0)
y_test = pd.Series(y_test_csv['label'], index=y_test_csv.index)
y_train_csv = pd.read_csv('D:\Descargas\datasets\ecore_dummy_y_train.csv', index_col=0)
y_train = pd.Series(y_train_csv['label'], index=y_train_csv.index)

with open('D:\Descargas\indices\ecore_dummy_indexes.pickle', 'rb') as f:
...
with open ('ecore_dummy_exp_results.pickle', 'wb') as f:
    pickle.dump(results_dict, f)

with open ('ecore_dummy_metrics_results.pickle', 'wb') as f:
    pickle.dump(metrics_dict, f)

with open ('ecore_dummy_top_metric_results.pickle', 'wb') as f:
    pickle.dump(top_metric_df, f)

with open ('ecore_dummy_rank_metric_results.pickle', 'wb') as f:
    pickle.dump(rank_metric_df, f)

with open ('ecore_dummy_sign_metric_results.pickle', 'wb') as f:
    pickle.dump(sign_metric_df, f)

with open ('ecore_dummy_ranksign_metric_results.pickle', 'wb') as f:
